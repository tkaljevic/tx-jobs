...
export const deleteJobAction = createAction('[Jobs] Delete job', props<{ jobId: string }>());
export const deleteJobSuccessAction = createAction('[Jobs] Delete job success');
export const deleteJobFailureAction = createAction('[Jobs] Delete job failure', props<{ error: string }>());
